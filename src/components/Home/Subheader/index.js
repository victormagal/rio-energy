    ...
    <>
      <div className="subheader w-full bg-blue-sky-night">
        <div className="xl:container mx-auto py-5 px-10 md:py-10 md:px-20  ">
          <h4 className="text-green-light font-serif font-bold text-md md:text-2xl">Atuamos no desenvolvimento,<br/> implantação e operação da energia.</h4>

          <div className="text-white font-serif font-bold text-2xl md:text-6xl">
